VGG19 is different than InsightFace in the sense that it is only a single network, and any pre-processing will need to be completed using a separate library (in our we can use TorchVision).
